...
class IntlPhoneField extends StatefulWidget {
  ...
  /// This is a flag to show countries in english. By default this widget show spanish countries.
  final bool englishCountries;
...
class _IntlPhoneFieldState extends State<IntlPhoneField> {
  ...
  void initState() {
    ...
    _countryList = widget.countries == null
        ? (widget.englishCountries ? enCountries : esCountries)
        : (widget.englishCountries  ? enCountries : esCountries)
